...
/**
 * Store identity and native configuration for Spinwit.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and Spinwit works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  backgroundColor: '#170B12',
  primaryColor: '#F472B6',
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.spinwit',
    buildNumber: BUILD,
    supportsTablet: true,
