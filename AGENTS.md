...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs spinwit`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.spinwit` |
| Scheme | `spinwit://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.spinwit.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/spinwit` |
